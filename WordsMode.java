...
public class WordsMode extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int selectedNumberWords = Integer.parseInt((String) jComboBox1.getSelectedItem());
        WordsModeGame wordsModeGame = new WordsModeGame(selectedNumberWords);
        wordsModeGame.setVisible(true);
    ...
    public void setNumberWords(int N){
        this.numberWords=N;
    }
    /**
